...
namespace LinkuraLocal::HookShare {
    ...
    namespace {
        ...
        std::mutex homeWallpaperRestoreMutex;
        ...
        static void ResetHomeWallpaperRestoreForAuthorization(const std::string& authorization) {
            std::lock_guard<std::mutex> lock(homeWallpaperRestoreMutex);
            if (authorization.empty() || authorization == homeWallpaperAuthorization) return;
        ...
        static void RememberHomeWallpaperAuthorization(void* headerParams) {
            ResetHomeWallpaperRestoreForAuthorization(
                FindAuthorizationHeader(ObjectToJsonOrString(headerParams))
            );
        }

        static void StoreHomeWallpaperRestoreCandidate(const nlohmann::json& value) {
            const auto detail = value.value("wallpaper_detail_setting_info", std::string{});
            const auto simple = value.value("wallpaper_simple_setting_info", std::string{});
            const bool isViewDetailWallpaper = value.value("is_view_detail_wallpaper", false);
        ...
        static void LoadHomeWallpaperSettingFromApiIfNeeded() {
            ...
            {
                std::lock_guard<std::mutex> lock(homeWallpaperRestoreMutex);
                if (homeWallpaperLoaded || homeWallpaperRestoreDisabled) return;
        ...
        static std::string ConvertHomeDetailWallpaperDataToString(void* customData) {
            ...
            static auto convertMethod = Il2cppUtils::GetMethodIl2cpp(
                ...
                "ConvertFromCustomData",
                2
            );
            if (!convertMethod || !convertMethod->methodPointer) return {};

            using ConvertFromCustomDataFn = Il2cppUtils::Il2CppString*(*)(void*, Il2cppUtils::Il2CppString*, Il2cppUtils::MethodInfo*);
            auto converted = reinterpret_cast<ConvertFromCustomDataFn>(convertMethod->methodPointer)(
                customData,
                Il2cppUtils::Il2CppString::New(""),
                convertMethod
            );
            return converted ? converted->ToString() : std::string{};
        }

        static std::string ConvertHomeSimpleWallpaperDataToString(void* customData) {
            if (!customData) return {};
            static auto convertMethod = Il2cppUtils::GetMethodIl2cpp(
                "Assembly-CSharp.dll",
                "Tecotec",
            ...
            using ConvertFromCustomDataFn = Il2cppUtils::Il2CppString*(*)(void*, Il2cppUtils::MethodInfo*);
            auto converted = reinterpret_cast<ConvertFromCustomDataFn>(convertMethod->methodPointer)(
                customData,
                convertMethod
            );
        ...
        static void* ConvertHomeDetailWallpaperDataFromString(const std::string& settingInfo) {
            if (!IsHomeDetailWallpaperSettingInfo(settingInfo)) return nullptr;
            static auto convertMethod = Il2cppUtils::GetMethodIl2cpp(
                "Assembly-CSharp.dll",
                "Tecotec",
                "StickerCustomDataMng",
            ...
            if (!convertMethod || !convertMethod->methodPointer) return nullptr;

            using ConvertFromStringFn = void*(*)(Il2cppUtils::Il2CppString*, Il2cppUtils::MethodInfo*);
            return reinterpret_cast<ConvertFromStringFn>(convertMethod->methodPointer)(
                Il2cppUtils::Il2CppString::New(settingInfo),
                convertMethod
            );
        }

        static void* ConvertHomeSimpleWallpaperDataFromString(const std::string& settingInfo) {
            if (!IsHomeSimpleWallpaperSettingInfo(settingInfo)) return nullptr;
            static auto convertMethod = Il2cppUtils::GetMethodIl2cpp(
                "Assembly-CSharp.dll",
                "Tecotec",
                "HomeCustomSimpleDataEvent",
